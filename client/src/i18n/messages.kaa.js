/** Qaraqalpaq — UI matnlari */
export const kaaMessages = {
  brand: 'CyberEdu',
  langLabel: 'Til',
  ...
  theme: 'Tema',
  module: 'Modul',
  sectionsSeparated: 'Bólimler ajratılǵan',
  ...
  testsPassMinDetail: 'Ótish ushın minimum {score}% kerek',
  ...
  resourceTypeHujjet: 'Hújjet',
  resourceTypeVideo: 'Video sabaq',
  resourceTypeStandart: 'Standart',
  resourceTypeQollanba: 'Qısqa qollanba',
  resourceTypeKurs: 'Kurs',
  resourceTypeMaqala: 'Maqala',
  resourceTypeCheatsheet: 'Qısqa esletpe',
  ...
  serverTimeout: 'Server juwap bermedi. Keyin qayta urınıp kóriń.',
};
